...
let delete_one_src_president = async (req,res,next) => {
    ...
    try {
       let del = await candidate.src_president.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
...
let delete_one_src_financial = async (req,res,next) => {
    let id = req.params.id
    try {
       let del = await candidate.src_financial.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
        res.status(500).json({res: "An error occured"})
    }
...
let delete_one_src_general = async (req,res,next) => {
    let id = req.params.id
    try {
       let del = await candidate.src_general.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
        res.status(500).json({res: "An error occured"})
    }
...
let delete_one_nugs_president = async (req,res,next) => {
    let id = req.params.id
    try {
       let del = await candidate.nugs_president.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
        res.status(500).json({res: "An error occured"})
    }
...
let delete_one_nugs_financial = async (req,res,next) => {
    let id = req.params.id
    try {
       let del = await candidate.nugs_financial.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
        res.status(500).json({res: "An error occured"})
    }
...
let delete_one_nugs_general = async (req,res,next) => {
    let id = req.params.id
    try {
       let del = await candidate.nugs_general.findByIdAndDelete(id).exec()
       if(del.$isDeleted()) res.json({res: "deleted"})
    } catch (error) {
        res.status(500).json({res: "An error occured"})
    }
